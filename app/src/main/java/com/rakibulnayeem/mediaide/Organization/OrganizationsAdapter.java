...
public class OrganizationsAdapter extends RecyclerView.Adapter<OrganizationsAdapter.MyViewHolder> {
    ...
    public OrganizationsAdapter(Context context, List<AddOrganizationsAdapter> adapterList) {
    ...
    @NonNull
    @Override
    public OrganizationsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull OrganizationsAdapter.MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // adding call history
                String type = "Blood Organization";
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView nameTv, addressTv, phoneNumberTv, zillaTv, openTv;
