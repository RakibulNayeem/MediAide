...
public class HospitalListAdmin extends AppCompatActivity implements View.OnClickListener {


    private RecyclerView recyclerView;
    HospitalListAdminAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_list_admin);
    ...
    public void onClick(View v) {
        if (v == dropDownIv || v == zillaTv )
        {
            ...
            intent.putExtra("name","hospital_list_admin");
        ...
        if (Zilla==null)
        {
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    adapter = new HospitalListAdminAdapter(HospitalListAdmin.this, adapterList);
