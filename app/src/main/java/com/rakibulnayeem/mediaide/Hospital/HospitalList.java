...
public class HospitalList extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v == dropDownIv || v == zillaTv )
        {
            ...
            intent.putExtra("name","hospital_list");
        ...
        if (Zilla==null)
        {
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    hospitalListAdapter = new HospitalListAdapter(HospitalList.this, adapterList);
