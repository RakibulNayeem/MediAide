...
import com.rakibulnayeem.mediaide.Doctor.AddDoctor;
...
public class HospitalListAdapter extends RecyclerView.Adapter<HospitalListAdapter.MyViewHolder> {
    ...
    public HospitalListAdapter(Context context, List<AddHospitalAdapter> adapterList) {
    ...
    @Override
    public void onBindViewHolder(@NonNull HospitalListAdapter.MyViewHolder holder, int position) {
