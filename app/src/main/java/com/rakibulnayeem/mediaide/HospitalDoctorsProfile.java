...
public class HospitalDoctorsProfile extends AppCompatActivity implements View.OnClickListener {
    ...
    TextView nameTv,degreeTv,chamberAddressTv,zillaTv,openTimeTv,ampmTv,closeTimeTv,ampm2Tv,phoneNumberTv;
    TextView specialityTv, feeTv, activeDayTv, hospitalTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_doctors_profile);
    ...
    public void onClick(View v) {
        if (v == callBtn) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if (ContextCompat.checkSelfPermission(HospitalDoctorsProfile.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(HospitalDoctorsProfile.this, new String[]{Manifest.permission.CALL_PHONE},MY_PERMISSIONS_REQUEST_CALL_PHONE);
                }
                else
                {
