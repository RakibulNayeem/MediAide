...
public class DonorYouAddedProfile  extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button smsBtn, callBtn, updateBtn;
    String donor_key;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donor_you_added_profile);
        this.setTitle("Donor Profile");
        ...
        donor_key = intent.getStringExtra("donor_key");


        nameTv = findViewById(R.id.donorNameTvId);
    ...
    public void onClick(View v) {
        if (v == callBtn) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if (ContextCompat.checkSelfPermission(DonorYouAddedProfile.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                    ActivityCompat.requestPermissions(DonorYouAddedProfile.this, new String[]{Manifest.permission.CALL_PHONE},MY_PERMISSIONS_REQUEST_CALL_PHONE);
                }
                else
                {
