...
public class AddDonorAdapter {


    private String name,uid,adder_uid,key,email,village,blood_group,upazila,zilla,phone_number,last_donation_date,status,donate_switch;




    public AddDonorAdapter() {
    }


    public AddDonorAdapter(String name, String uid, String adder_uid, String key, String email, String village, String blood_group, String upazila, String zilla, String phone_number, String last_donation_date, String status, String donate_switch) {
        this.name = name;
        this.uid = uid;
